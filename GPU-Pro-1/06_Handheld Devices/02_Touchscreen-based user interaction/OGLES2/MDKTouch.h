...
namespace MDK {
	namespace Input {
		...
		private:
			...
			TouchState();
		public:
			const float GetPositionX() const { return endPosX; };
			const float GetPositionY() const { return endPosY; };
		...
		public:
			...
			bool Synchronize(PrecisionTimer *pTimer = NULL);
