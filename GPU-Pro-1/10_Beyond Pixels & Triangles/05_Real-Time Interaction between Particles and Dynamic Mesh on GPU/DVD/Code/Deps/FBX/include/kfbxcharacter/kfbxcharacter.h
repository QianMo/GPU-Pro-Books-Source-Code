...
public:
    ...
    */
	...
	KFbxTypedProperty<fbxDouble1>						PullIterationCount;
	KFbxTypedProperty<KCHARACTERDEF_NAMESPACE::kCharacterPosture>				Posture;
	KFbxTypedProperty<fbxBool1>							ForceActorSpace;
	KFbxTypedProperty<fbxDouble1>						ScaleCompensation;
	KFbxTypedProperty<KCHARACTERDEF_NAMESPACE::kCharacterOffAutoUser>			ScaleCompensationMode;
	KFbxTypedProperty<fbxDouble1>						HipsHeightCompensation;
	KFbxTypedProperty<KCHARACTERDEF_NAMESPACE::kCharacterOffAutoUser>			HipsHeightCompensationMode;
	KFbxTypedProperty<fbxDouble1>						AnkleHeightCompensation;
	KFbxTypedProperty<KCHARACTERDEF_NAMESPACE::kCharacterOffAutoUser>			AnkleHeightCompensationMode;
	KFbxTypedProperty<fbxDouble1>						AnkleProximityCompensation;
	KFbxTypedProperty<KCHARACTERDEF_NAMESPACE::kCharacterOffAutoUser>			AnkleProximityCompensationMode;
	...
	KFbxTypedProperty<KCHARACTERDEF_NAMESPACE::kCharacterRollExtractionMode>		RollExtractionMode;
	...
	KFbxTypedProperty<KCHARACTERDEF_NAMESPACE::kCharacterContactBehaviour>		ContactBehaviour;
	KFbxTypedProperty<fbxBool1>							FootFloorContact;
	KFbxTypedProperty<fbxBool1>							FootAutomaticToes;
	KFbxTypedProperty<KCHARACTERDEF_NAMESPACE::kCharacterFloorPivot>				FootFloorPivot;
	...
	KFbxTypedProperty<KCHARACTERDEF_NAMESPACE::kCharacterFootContactType>		FootContactType;
	KFbxTypedProperty<KCHARACTERDEF_NAMESPACE::kCharacterFingerContactMode>		FootFingerContactMode;
	...
	KFbxTypedProperty<KCHARACTERDEF_NAMESPACE::kCharacterFloorPivot>				HandFloorPivot;
	...
	KFbxTypedProperty<KCHARACTERDEF_NAMESPACE::kCharacterHandContactType>		HandContactType;
	KFbxTypedProperty<KCHARACTERDEF_NAMESPACE::kCharacterFingerContactMode>		HandFingerContactMode;
	...
	KFbxTypedProperty<KCHARACTERDEF_NAMESPACE::kCharacterHipsTranslationMode>	HipsTranslationMode;
	...
	KFbxTypedProperty<KCHARACTERDEF_NAMESPACE::kCharacterOffAutoUser>			OrientationDampingMode;
	KFbxTypedProperty<fbxDouble1>												DisplacementDamping;
	KFbxTypedProperty<KCHARACTERDEF_NAMESPACE::kCharacterOffAutoUser>			DisplacementDampingMode;
	KFbxTypedProperty<fbxDouble1>												DisplacementMemory;
	KFbxTypedProperty<KCHARACTERDEF_NAMESPACE::kCharacterAutoUser>				DisplacementMemoryMode;
	KFbxTypedProperty<fbxDouble1>												HipsDisplacementDamping;
	KFbxTypedProperty<KCHARACTERDEF_NAMESPACE::kCharacterAutoUser>				HipsDisplacementDampingMode;
	KFbxTypedProperty<fbxDouble1>												AnkleDisplacementDamping;
	KFbxTypedProperty<KCHARACTERDEF_NAMESPACE::kCharacterAutoUser>				AnkleDisplacementDampingMode;
	KFbxTypedProperty<fbxDouble1>												WristDisplacementDamping;
	KFbxTypedProperty<KCHARACTERDEF_NAMESPACE::kCharacterAutoUser>				WristDisplacementDampingMode;
	KFbxTypedProperty<fbxDouble1>												Stabilization;
	KFbxTypedProperty<fbxDouble1>												AnkleStabilizationTime;
	KFbxTypedProperty<KCHARACTERDEF_NAMESPACE::kCharacterAutoUser>				AnkleStabilizationTimeMode;
	KFbxTypedProperty<fbxDouble1>												AnkleStabilizationPerimeter;
	KFbxTypedProperty<KCHARACTERDEF_NAMESPACE::kCharacterAutoUser>				AnkleStabilizationPerimeterMode;
	KFbxTypedProperty<fbxDouble1>												AnkleStabilizationAngularPerimeter;
	KFbxTypedProperty<KCHARACTERDEF_NAMESPACE::kCharacterOffAutoUser>			AnkleStabilizationAngularPerimeterMode;
	KFbxTypedProperty<fbxDouble1>												AnkleStabilizationFloorProximity;
	KFbxTypedProperty<KCHARACTERDEF_NAMESPACE::kCharacterOffAutoUser>			AnkleStabilizationFloorProximityMode;
	KFbxTypedProperty<fbxDouble1>												AnkleStabilizationDamping;
	KFbxTypedProperty<KCHARACTERDEF_NAMESPACE::kCharacterOffAutoUser>			AnkleStabilizationDampingMode;
	KFbxTypedProperty<fbxDouble1>												AnkleStabilizationRecoveryTime;
	KFbxTypedProperty<KCHARACTERDEF_NAMESPACE::kCharacterOffAutoUser>			AnkleStabilizationRecoveryTimeMode;
...
inline EFbxType FbxTypeOf( KCHARACTERDEF_NAMESPACE::kCharacterOffAutoUser const &pItem )			{ return eENUM; }
inline EFbxType FbxTypeOf( KCHARACTERDEF_NAMESPACE::kCharacterAutoUser const &pItem )				{ return eENUM; }
inline EFbxType FbxTypeOf( KCHARACTERDEF_NAMESPACE::kCharacterPosture const &pItem )				{ return eENUM; }
inline EFbxType FbxTypeOf( KCHARACTERDEF_NAMESPACE::kCharacterFloorPivot const &pItem )				{ return eENUM; }
inline EFbxType FbxTypeOf( KCHARACTERDEF_NAMESPACE::kCharacterRollExtractionMode const &pItem )		{ return eENUM; }
inline EFbxType FbxTypeOf( KCHARACTERDEF_NAMESPACE::kCharacterHipsTranslationMode const &pItem )	{ return eENUM; }
inline EFbxType FbxTypeOf( KCHARACTERDEF_NAMESPACE::kCharacterFootContactType const &pItem )		{ return eENUM; }
inline EFbxType FbxTypeOf( KCHARACTERDEF_NAMESPACE::kCharacterHandContactType const &pItem )		{ return eENUM; }
inline EFbxType FbxTypeOf( KCHARACTERDEF_NAMESPACE::kCharacterFingerContactMode const &pItem )		{ return eENUM; }
inline EFbxType FbxTypeOf( KCHARACTERDEF_NAMESPACE::kCharacterContactBehaviour const &pItem )		{ return eENUM; }
