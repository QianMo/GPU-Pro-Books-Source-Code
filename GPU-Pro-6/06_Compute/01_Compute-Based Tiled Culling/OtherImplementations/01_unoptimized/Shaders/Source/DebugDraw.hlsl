...
VS_OUTPUT_DRAW_POINT_LIGHTS DebugDrawPointLightsVS( VS_INPUT_DRAW_POINT_LIGHTS Input )
{
    ...
    float4 LightPositionViewSpace = mul(float4(g_PointLightBuffer[Input.InstanceID].v4PositionAndRadius.xyz, 1), g_mView);
    ...
    Output.Color = g_PointLightBuffer[Input.InstanceID].v4Color.rgb;
