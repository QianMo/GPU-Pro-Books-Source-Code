...
{
	theatre = new Theatre(pd3dDevice);
	theatre->createResources();
    return S_OK;
}
...
{
	theatre->setSwapChain(pSwapChain);
	theatre->createSwapChainResources();
    return S_OK;
}


//--------------------------------------------------------------------------------------
// Handle updates to the theatre.  This is called regardless of which D3D API is used
//--------------------------------------------------------------------------------------
void CALLBACK OnFrameMove( double fTime, float fElapsedTime, void* pUserContext )
{
	if(theatre)
		theatre->animate(fElapsedTime, fTime);
}


//--------------------------------------------------------------------------------------
// Render the theatre using the D3D10 device
//--------------------------------------------------------------------------------------
...
{
	theatre->releaseSwapChainResources();
}
...
{
	if(theatre)
		theatre->processMessage(hWnd, uMsg, wParam, lParam, pbNoFurtherProcessing);
    return 0;
}
