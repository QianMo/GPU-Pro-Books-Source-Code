...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/parametric
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/parametric
  DEFINES   += -DGLFW_NO_GLU -DDEBUG -DLINUX -DPARAMETRIC_RENDERER
  INCLUDES  += -I../../lib
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
  CFLAGS    += $(CPPFLAGS) $(ARCH) -Wall -msse -msse2 -g
  CXXFLAGS  += $(CFLAGS) 
  LDFLAGS   += 
  LIBS      += -lm -lpng -lglfw3 -lGL -lXrandr -lXxf86vm -lXi -lpthread -lX11 -lrt
...
ifeq ($(config),release)
  OBJDIR     = obj/release/parametric
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/parametric
  DEFINES   += -DGLFW_NO_GLU -DNDEBUG -DLINUX -DPARAMETRIC_RENDERER
  INCLUDES  += -I../../lib
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
