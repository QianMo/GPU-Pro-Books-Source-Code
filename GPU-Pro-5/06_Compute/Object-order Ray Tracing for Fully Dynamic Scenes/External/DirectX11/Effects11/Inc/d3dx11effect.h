...
#define D3DX11_EFFECT_VARIABLE_UNMANAGED               (1 << 3)
...
DECLARE_INTERFACE_(ID3DX11EffectUnorderedAccessViewVariable, ID3DX11EffectVariable)
{
    ...
    STDMETHOD(SetUnorderedAccessView)(THIS_ ID3D11UnorderedAccessView *pResource, UINT InitialCount = D3D11_KEEP_UNORDERED_ACCESS_VIEWS) PURE;
    STDMETHOD(GetUnorderedAccessView)(THIS_ ID3D11UnorderedAccessView **ppResource, UINT *pInitialCount = nullptr) PURE;
...
DECLARE_INTERFACE(ID3DX11EffectPass)
{
	...
	// breeze 2.0 MODIFIED
	STDMETHOD(Unbind)(THIS_ ID3D11DeviceContext* pContext) PURE;
