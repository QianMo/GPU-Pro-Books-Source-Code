...
struct SPassBlock : SBaseBlock, public ID3DX11EffectPass
{
    ...
    STDMETHOD(Apply)(UINT Flags, ID3D11DeviceContext* pContext, bool resetBufferCounters);
...
protected:
    ...
    void ApplyShaderBlock(SShaderBlock *pBlock, bool resetBufferCounters);
    BOOL ApplyRenderStateBlock(SBaseBlock *pBlock);
    BOOL ApplySamplerBlock(SSamplerBlock *pBlock);
    void ApplyPassBlock(SPassBlock *pBlock, bool resetBufferCounters);
