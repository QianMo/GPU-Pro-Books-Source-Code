...
Reflection.pvr: $(MEDIAPATH)/ReflectionMap.bmp
	$(PVRTEXTOOL) -m -fOGLPVRTC4 -i$(MEDIAPATH)/ReflectionMap.bmp -o$@

Thickness.pvr: $(MEDIAPATH)/ThicknessMap.bmp
	$(PVRTEXTOOL) -m -nt -fOGL8 -i$(MEDIAPATH)/ThicknessMap.bmp -o$@
