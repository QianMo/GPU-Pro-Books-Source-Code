...
namespace ComputeBasedTiledCulling
{
    ...
    public:
        ...
        ID3D11ShaderResourceView * const * GetDepthBoundsSRVParam() const { return &m_pDepthBoundsSRV; }
        ID3D11UnorderedAccessView * const * GetDepthBoundsUAVParam() const { return &m_pDepthBoundsUAV; }
        ...
        ID3D11ComputeShader * GetDepthBoundsCS() const { return m_pDepthBoundsCS; }
    ...
    private:
        ...
        ID3D11Texture2D*            m_pDepthBoundsTexture;
        ID3D11ShaderResourceView*   m_pDepthBoundsSRV;
        ID3D11UnorderedAccessView*  m_pDepthBoundsUAV;
        ...
        ID3D11ComputeShader*        m_pDepthBoundsCS;
