...
struct SPassBlock : SBaseBlock, public ID3DX11EffectPass
{
	...
	// breeze 2.0 MODIFIED
	STDMETHOD(Unbind)(ID3D11DeviceContext* pContext);
...
struct SUnorderedAccessView
{
    ...
    SUnorderedAccessView() 
    {
		...
		// breeze 2.0 MODIFIED: Allow for modification of internal counters
		InitialCount = D3D11_KEEP_UNORDERED_ACCESS_VIEWS;
    }
...
// breeze 2.0 MODIFIED: Allow for modification of internal counters
template<class T, class D3DTYPE> struct SCountingShaderDependency : public SShaderDependency<T, D3DTYPE>
{
    UINT *pInitialCounts;              // Array of initial counter values.

    SCountingShaderDependency()
    {
		pInitialCounts = NULL;
    }
};
...
// breeze 2.0 MODIFIED: Allow for modification of internal counters
typedef SCountingShaderDependency<SUnorderedAccessView*, ID3D11UnorderedAccessView*> SUnorderedAccessViewDependency;
...
protected:
	...
	// breeze 2.0 MODIFIED
	void UnbindPassBlock(SPassBlock *pBlock);
	void UnbindShaderBlock(SShaderBlock *pBlock);
