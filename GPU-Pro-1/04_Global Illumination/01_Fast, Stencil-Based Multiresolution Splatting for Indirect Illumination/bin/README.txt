...
* (Proceedings of the 2009 Symposium in Interactive 3D Graphics & Games) *
*                     Greg Nichols and Chris Wyman                       *
*                           University of Iowa                           *
*      More Information: http://www.cs.uiowa.edu/~cwyman/pubs.html       *
*                                                                        *
* NOTE: Stencil-based improvements presented in our EGSR 2009 paper      *
*       "Hierarchical Image-Space Radiosity for Interactive Global       *
*       Illumination" are also used in this demo.                        *
**************************************************************************

This directory contains executables and code for a demo for our paper
entitled:  "Multiresolution Splatting for Indirect Illumination."
