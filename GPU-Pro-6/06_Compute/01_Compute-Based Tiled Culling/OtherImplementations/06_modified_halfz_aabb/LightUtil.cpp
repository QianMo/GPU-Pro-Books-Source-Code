...
static XMFLOAT4             g_PointLightDataArrayCenterAndRadius[ComputeBasedTiledCulling::MAX_NUM_LIGHTS];
static DWORD                g_PointLightDataArrayColor[ComputeBasedTiledCulling::MAX_NUM_LIGHTS];
...
namespace ComputeBasedTiledCulling
{
    ...
    void LightUtil::RenderLights( float fElapsedTime, unsigned uNumPointLights, unsigned uNumSpotLights, const CommonUtil& CommonUtil ) const
    {
        ...
        if( uNumPointLights > 0 )
        {
            ...
            pd3dImmediateContext->VSSetShaderResources( 2, 1, GetPointLightBufferCenterAndRadiusSRVParam() );
            pd3dImmediateContext->VSSetShaderResources( 3, 1, GetPointLightBufferColorSRVParam() );
