...
namespace ComputeBasedTiledCulling
{
    ...
    public:
        ...
        ID3D11ShaderResourceView * const * GetPointLightBufferCenterAndRadiusSRVParam() const { return &m_pPointLightBufferCenterAndRadiusSRV; }
        ID3D11ShaderResourceView * const * GetPointLightBufferColorSRVParam() const { return &m_pPointLightBufferColorSRV; }
