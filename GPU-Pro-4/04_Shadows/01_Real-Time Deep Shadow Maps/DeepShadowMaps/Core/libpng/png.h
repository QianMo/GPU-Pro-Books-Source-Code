...
#include "..\zlib\zlib.h"			// MOD
#endif

#pragma warning(disable:4996)	// MOD
...
/* New members added in libpng-1.0.6 */
   ...
   png_size_t iccp_proflen;  /* ICC profile data length */
...
/* These were added in libpng-1.0.2 */
   ...
   png_size_t idat_size;     /* current IDAT size for read , mod x64*/
...
#  endif
 ...
 || defined(PNG_READ_EXPAND_SUPPORTED) || defined(PNG_READ_BACKGROUND_SUPPORTED)
   ...
   png_size_t skip_length;          /* bytes to skip in input data, mod x64 */
...
extern PNG_EXPORT(void,png_set_iCCP) PNGARG((png_structp png_ptr,
   ...
   png_charp profile, png_size_t proflen));
