...
namespace D3DX11Effects
{
    ...
    UINT g_pZeros[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
    ...
    if( pBlock->UAVDepCount > 0 )
    {
        ...
        else
        {
			...
			if(keepUavCounters)
				...
				m_pContext->OMSetRenderTargetsAndUnorderedAccessViews( D3D11_KEEP_RENDER_TARGETS_AND_DEPTH_STENCIL, NULL, NULL, pUAVDep->StartIndex, pUAVDep->Count, pUAVDep->ppD3DObjects, g_pZeros );
        }
    }
