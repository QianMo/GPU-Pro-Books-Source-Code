...
GrammarLoader::GrammarLoader(GrammarDescriptor *aGrammarDesc, AxiomDescriptor *anAxiomDesc):grammarDesc(aGrammarDesc),axiomDesc(anAxiomDesc)
{
}

GrammarLoader::~GrammarLoader(void)
{
}
