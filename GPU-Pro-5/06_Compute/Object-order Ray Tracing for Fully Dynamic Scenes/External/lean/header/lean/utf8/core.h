...
#include <iterator>
#include "types.h" // MONITOR/MODIFIED: lean types
...
namespace utf8
{
	...
	typedef lean::uint1   uint8_t;	// MONITOR/MODIFIED: lean types
    typedef lean::uint2   uint16_t;	// MONITOR/MODIFIED: lean types
    typedef lean::uint4   uint32_t;	// MONITOR/MODIFIED: lean types
