...
HRESULT CDXUTDialogResourceManager::OnD3D11CreateDevice( ID3D11Device* pd3dDevice, ID3D11DeviceContext* pd3d11DeviceContext )
{
	...
	m_SpriteBufferBytes11 = 0;		// was forgotten
...
{
	if(!pd3dDevice || !pd3dImmediateContext)			// there is a lot of confusion with device references
	{
		pd3dDevice = this->m_pd3d11Device;
		pd3dImmediateContext = this->m_pd3d11DeviceContext;
	}
