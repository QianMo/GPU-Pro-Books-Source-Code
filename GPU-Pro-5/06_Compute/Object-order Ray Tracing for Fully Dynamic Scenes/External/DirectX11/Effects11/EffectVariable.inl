...
public:
    ...
    STDMETHOD(SetUnorderedAccessView)(ID3D11UnorderedAccessView *pResource, UINT InitialCount) { return E_FAIL; }
    STDMETHOD(GetUnorderedAccessView)(ID3D11UnorderedAccessView **ppResource, UINT *pInitialCount) { return E_FAIL; }
...
public:
	...
	// breeze 2.0 MODIFIED
	STDMETHOD(Unbind)(ID3D11DeviceContext* pContext) { return E_FAIL; }
...
struct TGlobalVariable : public TVariable<TTopLevelVariable<IBaseInterface> >
{
    ...
    STDMETHOD(GetDesc)(D3DX11_EFFECT_VARIABLE_DESC *pDesc)
    {
		...
		if (ExplicitBindPoint == -2)
		{
			pDesc->ExplicitBindPoint = 0;
			pDesc->Flags |= D3DX11_EFFECT_VARIABLE_UNMANAGED;
		}
        else if (ExplicitBindPoint != -1)
        {
...
{
	// breeze 2.0 MODIFIED: Allow for modification of internal counters
    STDMETHOD(SetUnorderedAccessView)(ID3D11UnorderedAccessView *pResource, UINT InitialCount);
    STDMETHOD(GetUnorderedAccessView)(ID3D11UnorderedAccessView **ppResource, UINT *pInitialCount);
...
template<typename IBaseInterface>
HRESULT TUnorderedAccessViewVariable<IBaseInterface>::SetUnorderedAccessView(ID3D11UnorderedAccessView *pResource, UINT InitialCount)
{
    HRESULT hr = S_OK;
	...
	// breeze 2.0 MODIFIED: Allow for modification of internal counters
	Data.pUnorderedAccessView->InitialCount = InitialCount;
...
template<typename IBaseInterface>
HRESULT TUnorderedAccessViewVariable<IBaseInterface>::GetUnorderedAccessView(ID3D11UnorderedAccessView **ppResource, UINT *pInitialCount)
{
    HRESULT hr = S_OK;
    ...
    *ppResource = Data.pUnorderedAccessView->pUnorderedAccessView;
	// breeze 2.0 MODIFIED: Allow for modification of internal counters
	if (pInitialCount)
		*pInitialCount = Data.pUnorderedAccessView->InitialCount;
    SAFE_ADDREF(*ppResource);
